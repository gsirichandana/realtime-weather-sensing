   // google.setOnLoadCallback(drawChart);
    ...
    function drawChart1() {
		...
		data1.addColumn('number','MinTemp');
		data1.addColumn('number','MaxTemp');
		data1.addRows(setGraphData.features);
		console.log(setGraphData.features);
        var options1 = {
          title: 'Temperature',
          curveType: 'function',
        ...
        var chart1 = new google.visualization.LineChart(document.getElementById('curve_chart_temp'));
